...
impl Packet {
    pub fn to_core_packet(&self) -> cosmic_ext_connect_core::Packet {
        cosmic_ext_connect_core::Packet {
            id: self.id,
    ...
    pub fn from_core_packet(packet: cosmic_ext_connect_core::Packet) -> Self {
        Self {
            id: packet.id,
