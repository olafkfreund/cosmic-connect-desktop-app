...
//!
//! ```rust,ignore
//! use cosmic_ext_connect_protocol::plugins::audiostream::audio_backend::{AudioBackend, BackendConfig};
//!
//! # async fn example() -> cosmic_ext_connect_protocol::Result<()> {
