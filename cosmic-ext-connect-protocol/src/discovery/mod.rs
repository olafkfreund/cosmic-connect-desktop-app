//! CConnect Device Discovery
//!
//! This module implements UDP broadcast-based device discovery for CConnect.
//!
//! ## Discovery Protocol
//!
...
/// Device types supported by CConnect
...
impl DeviceInfo {
    ...
    ///
    /// CConnect uses UUIDs with underscores instead of hyphens
