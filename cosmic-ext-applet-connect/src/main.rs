    ...
    fn update(&mut self, message: Self::Message) -> Task<Self::Message> {
        match message {
            ...
            Message::ScreenshotReceived(device_id, image_data) => {
                ...
                let filename = format!("cosmic-ext-connect_{}_{}.png", device_name, timestamp);
            ...
            Message::LaunchScreenMirror(device_id) => {
                let cmd = "cosmic-ext-connect-mirror";
                let args = &[&device_id];
            ...
            Message::OpenManager => {
                ...
                if let Err(e) = std::process::Command::new("cosmic-ext-connect-manager").spawn() {
            ...
            Message::LaunchManager(device_id) => {
                ...
                if let Err(e) = std::process::Command::new("cosmic-ext-connect-manager")
                    .arg("--device")
                    .arg(&device_id)
                    .spawn()
                {
...
impl CConnectApplet {
    ...
    fn view_settings_window(&self, device_id: &str) -> Element<'_, Message> {
        ...
        let content = column![
            ...
            text("~/.config/cosmic-ext-connect/config.toml").size(12),
        ]
        .spacing(space_xs())
        .padding(space_xs());
