...
async fn test_transfer_limit_exhaustion() {
    ...
    let transfer1 =
        cosmic_ext_connect_protocol::TransferInfo::new("t1".to_string(), "device-1".to_string(), 500);
    resource_manager.register_transfer(transfer1).await.unwrap();

    let transfer2 =
        cosmic_ext_connect_protocol::TransferInfo::new("t2".to_string(), "device-2".to_string(), 500);
    resource_manager.register_transfer(transfer2).await.unwrap();

    // Third transfer should fail (max concurrent reached)
    let transfer3 =
        cosmic_ext_connect_protocol::TransferInfo::new("t3".to_string(), "device-3".to_string(), 500);
...
async fn test_transfer_size_limit_exhaustion() {
    ...
    let transfer1 = cosmic_ext_connect_protocol::TransferInfo::new(
        "t1".to_string(),
        "device-1".to_string(),
    ...
    let transfer2 =
        cosmic_ext_connect_protocol::TransferInfo::new("t2".to_string(), "device-1".to_string(), 1000);
    resource_manager.register_transfer(transfer2).await.unwrap();

    // Another transfer that would exceed total should fail
    let transfer3 = cosmic_ext_connect_protocol::TransferInfo::new(
        "t3".to_string(),
        "device-2".to_string(),
    ...
    let transfer4 =
        cosmic_ext_connect_protocol::TransferInfo::new("t4".to_string(), "device-3".to_string(), 100);
...
async fn test_memory_pressure_detection() {
    ...
    let transfer = cosmic_ext_connect_protocol::TransferInfo::new(
        "t1".to_string(),
        "device-1".to_string(),
...
async fn test_packet_retry_queue() {
    ...
    // Queue packets
    let packet1 = cosmic_ext_connect_protocol::Packet::new("cconnect.ping", serde_json::json!({}));
    let packet2 = cosmic_ext_connect_protocol::Packet::new("cconnect.share", serde_json::json!({}));
...
async fn test_packet_retry_exhaustion() {
    ...
    // Queue packet
    let packet = cosmic_ext_connect_protocol::Packet::new("cconnect.test", serde_json::json!({}));
    recovery_manager
...
async fn test_resource_summary() {
    ...
    let transfer =
        cosmic_ext_connect_protocol::TransferInfo::new("t1".to_string(), "device-1".to_string(), 1000);
    resource_manager.register_transfer(transfer).await.unwrap();
...
async fn test_device_specific_tracking() {
    ...
    let transfer3 =
        cosmic_ext_connect_protocol::TransferInfo::new("t3".to_string(), "device-2".to_string(), 1000);
    resource_manager.register_transfer(transfer3).await.unwrap();
