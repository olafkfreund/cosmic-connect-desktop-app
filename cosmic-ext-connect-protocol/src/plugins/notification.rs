...
///
/// ```rust
/// use cosmic_ext_connect_protocol::plugins::notification::NotificationUrgency;
///
...
///
/// ```rust
/// use cosmic_ext_connect_protocol::plugins::notification::NotificationAction;
///
...
///
/// ```rust
/// use cosmic_ext_connect_protocol::plugins::notification::NotificationLink;
///
...
///
/// ```rust
/// use cosmic_ext_connect_protocol::plugins::notification::Notification;
///
...
impl Notification {
    ...
    ///
    /// ```rust
    /// use cosmic_ext_connect_protocol::plugins::notification::{Notification, NotificationLink};
    ///
    /// let mut notif = Notification::new("1", "App", "Title", "Text", true);
    ...
    ///
    /// ```rust
    /// use cosmic_ext_connect_protocol::plugins::notification::{Notification, NotificationUrgency};
    ///
    /// let mut notif = Notification::new("1", "App", "Title", "Text", true);
    ...
    ///
    /// ```rust
    /// use cosmic_ext_connect_protocol::plugins::notification::{Notification, NotificationAction};
    ///
    /// let mut notif = Notification::new("1", "App", "Title", "Text", true);
...
/// use cosmic_ext_connect_protocol::Plugin;
///
...
impl NotificationPlugin {
    ...
    ///
    /// ```rust
    /// use cosmic_ext_connect_protocol::plugins::notification::{NotificationPlugin, Notification};
    ///
    /// let plugin = NotificationPlugin::new();
    ...
    ///
    /// ```rust
    /// use cosmic_ext_connect_protocol::plugins::notification::{NotificationPlugin, NotificationUrgency};
    ///
    /// let plugin = NotificationPlugin::new();
