...
//!
//! ```rust,ignore
//! use cosmic_ext_connect_protocol::plugins::ping::PingPlugin;
...
///
/// ```rust
/// use cosmic_ext_connect_protocol::plugins::ping::PingPluginFactory;
/// use cosmic_ext_connect_protocol::plugins::PluginFactory;
/// use std::sync::Arc;
///
