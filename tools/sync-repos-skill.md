...
Claude:
🔍 Analyzing cosmic-connect-desktop-app changes...
...
```
⚠️ Conflict detected in cosmic-connect-android!
...
```
📋 This change requires multiple steps:
...
- ❌ Never auto-syncs without your approval
- ❌ Never makes assumptions about your intent
