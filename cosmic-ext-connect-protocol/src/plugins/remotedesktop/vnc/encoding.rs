...
//!
//! ```ignore
//! use cosmic_ext_connect_protocol::plugins::remotedesktop::vnc::encoding::FrameEncoder;
//! use cosmic_ext_connect_protocol::plugins::remotedesktop::capture::QualityPreset;
//!
