...
/// DBus object path
#[allow(dead_code)]
pub const OBJECT_PATH: &str = "/io/github/olafkfreund/CosmicExtConnect";
...
#[proxy(
    ...
    default_service = "io.github.olafkfreund.CosmicExtConnect",
    default_path = "/io/github/olafkfreund/CosmicExtConnect"
)]
trait CConnect {
...
#[proxy(
    ...
    default_service = "io.github.olafkfreund.CosmicExtConnect",
    default_path = "/io/github/olafkfreund/CosmicExtConnect/Open"
)]
trait CConnectOpen {
...
impl DbusClient {
    ...
    pub async fn forget_device(&self, device_id: &str) -> Result<()> {
        self.proxy
            ...
            .await
            .context("Failed to call forget_device")
    }
