...
use cosmic_ext_applet_connect::dbus_client::{DaemonEvent, DbusClient};
use cosmic_ext_connect_protocol::plugins::screenshare::decoder::VideoDecoder;
use cosmic_ext_connect_protocol::plugins::screenshare::stream_receiver::StreamReceiver;
use cosmic_ext_connect_protocol::plugins::screenshare::stream_sender::FrameType;
...
impl cosmic::Application for MirrorApp {
    ...
    const APP_ID: &'static str = "io.github.olafkfreund.CosmicExtConnect.Mirror";
