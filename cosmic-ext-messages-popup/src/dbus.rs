...
#[interface(name = "io.github.olafkfreund.CosmicExtMessagesPopup")]
impl MessagesPopupService {
...
pub async fn start_dbus_service(
    ...
    info!("D-Bus service started: io.github.olafkfreund.CosmicExtMessagesPopup");
...
impl MessagesPopupClient {
    ...
    pub async fn notify_message(&self, data: &NotificationData) -> zbus::Result<()> {
        let proxy = zbus::Proxy::new(
            &self.connection,
            "io.github.olafkfreund.CosmicExtMessagesPopup",
