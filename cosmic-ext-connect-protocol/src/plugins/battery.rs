...
//!
//! ```rust,ignore
//! use cosmic_ext_connect_core::plugins::battery::{BatteryPlugin, BatteryStatus};
...
///
/// ```rust
/// use cosmic_ext_connect_protocol::plugins::battery::BatteryPlugin;
...
impl BatteryPlugin {
    ...
    ///
    /// ```rust
    /// use cosmic_ext_connect_protocol::plugins::battery::{BatteryPlugin, BatteryStatus};
    ///
    /// let plugin = BatteryPlugin::new();
...
impl Plugin for BatteryPlugin {
    ...
    async fn handle_packet(&mut self, packet: &Packet, device: &mut Device) -> Result<()> {
        if packet.is_type("cconnect.battery") || packet.is_type("kdeconnect.battery") {
