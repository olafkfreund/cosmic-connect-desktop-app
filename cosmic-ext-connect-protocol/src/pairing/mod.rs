...
//!
//! ```no_run
//! use cosmic_ext_connect_protocol::pairing::{PairingService, PairingEvent, PairingConfig};
//!
//! #[tokio::main]
//! async fn main() {
...
// CertificateInfo now comes from cosmic-ext-connect-core (re-exported in lib.rs)
