...
//!
//! ```rust
//! use cosmic_ext_connect_protocol::Result;
//!
...
//!
//! ```rust
//! use cosmic_ext_connect_protocol::{ProtocolError, Result};
//!
...
pub enum ProtocolError {
    ...
    /// cosmic-ext-connect-core protocol error
    ///
    /// Automatically converted from `cosmic_ext_connect_core::ProtocolError`.
    /// This enables seamless error propagation from the core TLS layer.
    #[error("Core protocol error: {0}")]
    CoreProtocol(#[from] cosmic_ext_connect_core::ProtocolError),
