//! Clipboard Plugin
//!
//! Enables bidirectional text clipboard synchronization between KDE Connect devices.
...
//!
//! ```rust,ignore
//! use kdeconnect_protocol::plugins::clipboard::*;
...
///
/// ```rust
/// use kdeconnect_protocol::plugins::clipboard::ClipboardState;
///
