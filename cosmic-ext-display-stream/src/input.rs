...
impl TouchEvent {
    ...
    ///
    /// ```
    /// use cosmic_ext_display_stream::input::{TouchEvent, TouchAction};
    ///
...
impl InputHandler {
    ...
    ///
    /// ```
    /// use cosmic_ext_display_stream::input::InputHandler;
    ///
    ...
    ///
    /// ```
    /// use cosmic_ext_display_stream::input::{InputHandler, TouchEvent, TouchAction};
    ///
