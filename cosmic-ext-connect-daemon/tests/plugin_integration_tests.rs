...
use anyhow::Result;
use cosmic_ext_connect_protocol::plugins::{
...
fn create_mock_device() -> Device {
    Device {
        ...
        connection_state: cosmic_ext_connect_protocol::ConnectionState::Connected,
        pairing_status: cosmic_ext_connect_protocol::PairingStatus::Paired,
        is_trusted: true,
        last_seen: 0,
...
async fn test_plugin_trait_downcast() {
    use cosmic_ext_connect_protocol::plugins::Plugin;
...
async fn test_plugin_manager_battery_query() {
    use cosmic_ext_connect_protocol::plugins::PluginManager;
