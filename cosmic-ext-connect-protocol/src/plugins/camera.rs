...
//!
//! - [ ] Camera enumeration
//! - [x] V4L2 integration (Linux) - via cosmic-ext-connect-core/video
...
#[cfg(feature = "video")]
use cosmic_ext_connect_core::plugins::camera::CameraFrame as CoreCameraFrame;
#[cfg(feature = "video")]
use cosmic_ext_connect_core::video::{CameraDaemon, CameraDaemonConfig, PixelFormat};
...
///
/// ```rust,ignore
/// use cosmic_ext_connect_core::plugins::camera::create_camera_list_request;
///
...
///
/// ```rust,ignore
/// use cosmic_ext_connect_protocol::plugins::camera::create_camera_start_request;
///
...
///
/// ```rust,ignore
/// use cosmic_ext_connect_protocol::plugins::camera::create_camera_stop_request;
///
